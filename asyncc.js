...
const preMovie = async () => {
  ...
  console.log(`husband: but no i am hungry`);
  console.log(`wife: sorry i forgot to ask u for having popcorn but if u dont mind we can drink colddrink `)
 
  console.log(`now husband is in comma and wife is in theatre`);
   return ticket;
